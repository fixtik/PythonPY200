...
class LinkedList:
    ...
    def index(self, value: int) -> int:
        """
        Возвращает индекс первого элемента списка с заданным значением
        :param value: значение
        :return: индек эдемента или ошибка
        """
...
if __name__ == '__main__':
    ...
    print(linked_list, linked_list.index(4))
    print(linked_list, linked_list.index('bolt'))
